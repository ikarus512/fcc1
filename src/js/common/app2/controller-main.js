 ...
 * @desc app2 controllers
 * @memberOf clients.Modules.app2
 */
(function() {
    'use strict';
    ...
    angular
    .module('app2')
    .controller('myApp2ControllerMain', myApp2ControllerMain);

    myApp2ControllerMain.$inject = [
        '$scope', 'cafeStorage', 'MyError', 'MyConst', 'User', 'backendParams'
    ];

    /**
     * @classdesc App2 controller
     * @class
     * @param {Object} $scope
     * @param {Object} cafeStorage
    ...
    )
    {
         ...
         * Map initializations
         * @static
         * @memberOf clients.Modules.app2.Controllers.myApp2ControllerMain
         */
        ...
        /**
         * List selected cafe's timeslots
         * @static
         * @param {number} _id Cafe id
         * @memberOf clients.Modules.app2.Controllers.myApp2ControllerMain
         */
        ...
        /**
         * Refresh cafe timeslots data (get from server)
         * @static
         * @param {Object} cafe Cafe
         * @memberOf clients.Modules.app2.Controllers.myApp2ControllerMain
         */
        ...
        /**
         * Move map (change center/zoom/radius)
         * @static
         * @param {Object} newOpts New options object
         * @memberOf clients.Modules.app2.Controllers.myApp2ControllerMain
         */
